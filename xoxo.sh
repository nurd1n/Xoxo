...
if [[ $? -eq 0 ]]; then
# check versi
if [ "$(bin/wget.exe -q --no-check-certificate https://raw.githubusercontent.com/nurd1n/Xoxo/master/bin/xoxoversion -O - | grep '1.1.3')" == "1.1.3" ]; then

clear
echo -n -e "\e[1m\e[93m$(date)\e[0m
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
~                          \e[1m\e[96mXOXO Version 1.1.3\e[0m                         ~
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
if [[ $? -eq 0 ]]; then
# check versi
if [ "$(wget -q --no-check-certificate https://raw.githubusercontent.com/nurd1n/Xoxo/master/bin/xoxoversion -O - | grep '1.1.3')" == "1.1.3" ]; then
